...
double Valuation::getDrift()  {
    return exp((r - 0.5 * sigmaYearly * sigmaYearly) * (T / N) + dist(gen));
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void ValuationSMC::step(double& survivalRate) {
    ...
    increment(survivalRate, alive, dead);    
    survivalRate *= (double)alive.size() / particles.size();
    resample(alive, dead);
}


void ValuationSMC::increment(double& survivalRate, vector<int>& alive, vector<int>& dead) {
