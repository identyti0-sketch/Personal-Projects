...
Changes:
  ...
  - The RNG engine was changed from mersenne twister to Philox, which is more lightweight, faster and thread-safe, in preparation of later versions with threading.
